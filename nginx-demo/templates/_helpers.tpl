...
dwp.gov.uk-application: nginx-demo
dwp.gov.uk-business-project: nginx-demo
dwp.gov.uk-environment: {{ .Values.environment }}
dwp.gov.uk-function: nginx-demo
dwp.gov.uk-role: nginx-demo
{{- end -}}
